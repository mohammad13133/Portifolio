  ...
  return (
    ...
    >
      ...
      <div class="w-full px-4 sm:px-8 md:px-16 lg:px-24">
        <div class="w-full px-4 sm:px-8 md:px-16 lg:px-24">
          <form class="w-full space-y-4 flex flex-col items-center justify-center reveal-bottom-contact">
            <div class="flex flex-wrap gap-4 justify-center w-full mt-4">
              <div class="w-full sm:w-[300px]">
                <input
                  class="bg-gray-600 appearance-none border-2 border-gray-600 rounded-lg w-full py-2 px-4 leading-tight focus:outline-none  focus:text-white focus:bg-color-3"
                  id="inline-full-name"
                  type="text"
            ...
            <div class="w-full sm:w-[616px]">
              <textarea
                class="bg-gray-600 appearance-none border-2 border-gray-600 rounded-lg w-full py-2 px-4 leading-tight focus:outline-none h-40 resize-none focus:text-white focus:bg-color-3"
                id="inline-message"
